...
<div class="main-header">
    ...
    <p>Tác giả: Ma Công Trực - Trường Tiểu học Minh Quang - ĐT: 0383 710 555</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Ma Công Trực - Trường Tiểu học MInh Quang - ĐT: 0383 710 555</div>", unsafe_allow_html=True)
